...
export default function CocinaView() {
  ...
  useEffect(() => {
    ...
    const compact = localStorage.getItem('cocina_compact_mode') === 'true';
          ...
          <div className="flex items-center gap-3">
            <label className="flex items-center gap-2 text-sm text-gray-600">
              <input
                ...
                checked={compactMode}
                onChange={(e) => { setCompactMode(e.target.checked); localStorage.setItem('cocina_compact_mode', e.target.checked); }}
              />
              Vista Compacta
            </label>
          </div>
