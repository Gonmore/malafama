...
export default function BarView() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      {/* Navbar */}
      <Navbar roleLabel="Bar" pedidosCount={pedidosPendientesFiltrados.length} darkMode={darkMode} />
      <EventoSelector selectedEvento={selectedEvento} onEventoChange={setSelectedEvento} accent="blue" />
