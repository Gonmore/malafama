...
export default function AdminDashboard() {
  ...
  const { localActivo, setLocalActivo, setLocales } = useLocalStore();
  ...
  const cargarDashboard = async () => {
    try {
      ...
      // Usar el local activo si existe, sino el primero o el del usuario
      const local = localActivo || locales[0] || user?.local || null;
      if (local && !localActivo) {
        setLocalActivo(local);
      }
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="hidden sm:inline">Crear Nuevo Local</span>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-6 mb-6 sm:mb-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
            ...
            <button
              ...
              className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-blue-300 transition-all text-left"
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Ajustes del local</p>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-8">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-sm p-4 sm:p-6 text-white">
            ...
            <p className="text-2xl sm:text-4xl font-bold">${stats.ventasHoy.toFixed(2)}</p>
