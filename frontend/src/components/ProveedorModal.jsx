      ...
      <div className="bg-slate-800 rounded-lg max-w-lg w-full p-6 max-h-[90vh] overflow-y-auto">
        <div className="flex items-start justify-between gap-4 mb-4">
          ...
          <button
            ...
            className="px-2 py-1 rounded text-slate-400 hover:bg-slate-800"
          >
            ✕
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-slate-600 bg-slate-900 text-slate-100 placeholder-slate-500 rounded-lg focus:ring-2 focus:ring-blue-500"
              required
            />
          </div>
